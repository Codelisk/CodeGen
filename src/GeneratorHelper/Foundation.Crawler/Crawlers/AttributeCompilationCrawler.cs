...
namespace Foundation.Crawler.Crawlers
{
    public class AttributeCompilationCrawler
    {
        ...
        public INamedTypeSymbol GetAttribute<TAttribute>() where TAttribute : Attribute
        {
        ...
        public string AttributeUrl<TAttribute>(INamedTypeSymbol dto) where TAttribute : BaseHttpAttribute
        {
            // Find the property with the Url attribute
        ...
        private INamedTypeSymbol UserOrDefault<TAttribute>(INamedTypeSymbol dto, bool isUser = false)
