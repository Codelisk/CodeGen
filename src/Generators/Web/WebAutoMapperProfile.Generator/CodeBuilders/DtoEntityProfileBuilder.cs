...
namespace WebAutoMapperProfile.Generator.CodeBuilders
{
    ...
    {
        public DtoEntityProfileBuilder(string codeBuilderNamespace)
        ...
        )
        {
            ...
            result
                ...
                //Removed for performance.AddDtoUsing(attributeCompilationCrawler)
                ...
                .WithBody(x =>
                {
                    ...
                    {
                        x.AppendLine(
                            $"{Constants.AutoMapperCreateMap}<{d.Name}, {d.EntityFromDto(context).Name}>().{Constants.AutoMapperReverseMap}();"
                        );
